...
CS_SEED = CrawlStrategy('Seed Crawl Strategy', 'Seed', charlotte_web.PROTOCOL_SEED, [constants.PROVIDER_SEED], '',
                        {'type': 'matchAll', 'provider': constants.PROVIDER_SSH}, {}, {})
CS_HINT = CrawlStrategy('Hint Crawl Strategy', 'Hint', charlotte_web.PROTOCOL_HINT, [constants.PROVIDER_HINT], '',
                        {}, {}, {})
